...
export default function Hero() {
  return (
    <section className="pt-24 md:pt-32 pb-16 md:pb-20 px-4 sm:px-6 overflow-x-hidden bg-background text-foreground transition-colors duration-300">
      ...
      <div className="max-w-5xl mx-auto text-center">
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="relative inline-block">
            ...
            <h1 className="relative text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black tracking-tight leading-tight">
              Blockchain{" "}
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
            ...
            <div className="flex items-center gap-0.5 justify-center">
              {/* Left Parenthesis */}
              <span className="text-4xl md:text-5xl lg:text-6xl font-black select-none">
                (
              </span>

              {/* Logo */}
              <Image
                src="/assets/betlogo.svg"
                alt="Brand Logo"
                width={140}
                height={40}
        ...
        {/* Subtitle */}
        <p className="mt-6 text-base sm:text-lg md:text-2xl max-w-2xl mx-auto leading-relaxed text-foreground/90">
